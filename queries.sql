...
==========================================
3. 집계 3개 (COUNT, SUM, AVG 중 2개 이상 + GROUP BY)
==========================================
...
## Q12. 대여 기록이 한 번도 없는 회원의 이름 조회 (NOT IN 서브쿼리)
SELECT name 
FROM member 
...
## Q13. 회원 ID 1번이 빌린 2번 도서에 대해 현재 시간으로 반납 처리 업데이트
UPDATE rental 
SET returned_at = CURRENT_TIMESTAMP 
WHERE member_id = 1 AND book_id = 2 AND returned_at IS NULL;

## Q14. 카테고리 ID가 없는 유령 도서 데이터 일괄 삭제
DELETE FROM book 
...
## Q15. 대여일(rented_at) 기준 검색 및 정렬 성능 최적화를 위한 인덱스 생성
